...
- **Ready to run experiments?** [`../experiments/experiment-validity.md`](../experiments/experiment-validity.md) (validity audit + go/no-go), [`../experiments/experiment-design.md`](../experiments/experiment-design.md) (the 3 experiments), and [`../experiments/results/experiment-results.md`](../experiments/results/experiment-results.md) (recorded E2a/E1 results).
